...
mixin $ProjectDetailRoute on GoRouteData {
  static ProjectDetailRoute _fromState(GoRouterState state) =>
      ProjectDetailRoute(projectId: state.pathParameters['projectId']!);
...
RouteBase get $myTasksRoute =>
    GoRouteData.$route(path: '/my-tasks', factory: $MyTasksRoute._fromState);

mixin $MyTasksRoute on GoRouteData {
  static MyTasksRoute _fromState(GoRouterState state) => const MyTasksRoute();

  @override
  String get location => GoRouteData.$location('/my-tasks');
...
mixin $TaskDetailRoute on GoRouteData {
  static TaskDetailRoute _fromState(GoRouterState state) =>
      TaskDetailRoute(taskId: state.pathParameters['taskId']!);
